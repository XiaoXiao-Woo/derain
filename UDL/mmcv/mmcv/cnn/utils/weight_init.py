...
class PretrainedInit(object):
    ...
    def __call__(self, module):
        ...
        if self.prefix is None:
            print_log(f'load model from: {self.checkpoint}')
            # load_checkpoint(
                # module,
                # self.checkpoint,
                # map_location=self.map_location,
                # strict=False)
            load_checkpoint('none', "", module, self.checkpoint, map_location='cpu', strict=False)
        else:
            print_log(
...
def _initialize(module, cfg, wholemodule=False):
    ...
    func(module) # mmcv.cnn.utils.weight_init.PretrainedInit
