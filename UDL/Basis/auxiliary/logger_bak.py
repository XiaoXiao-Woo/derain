...
#         handler.setLevel(logging.DEBUG)  # log_level
...
# def get_logger(name, cfg=None, cfg_name=None, phase='train', log_level=logging.INFO, file_mode='w'):  # log_file=None,
...
def get_logger(name, cfg, cfg_name, phase='train', dist_print=0):
    ...
    return logger, str(final_output_dir), str(model_save_dir), str(tensorboard_log_dir) #logger,
