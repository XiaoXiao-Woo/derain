...
matcaffe_path = 'D:/ProjectSets/NDA/Attention/compared_100L/caffe-windows-ms/matlab/';
...
% Set Datasets.
%
rain_dir = './Dataset/Rain100L/rain/';
norain_dir = './Dataset/Rain100L/norain/';

files=dir([rain_dir, '*.png']);
norain_files=dir([norain_dir, '*.png']);
