...
num_patches = 20;
%%% 
root_dir = '.';%'D:/Datasets/derain/DDN';
data_file_list = strcat(root_dir, '/rainy_image_dataset/input/*.jpg');
%% initialization
...
for j = 1:num_h5_files
  ...
  for i = 1 : num_patches
    ...
    im_input = imread(strcat(root_dir, '/rainy_image_dataset/input/', listing(r_idx).name));  % input: rainy image
    ...
    im_label = imread(strcat(root_dir, '/rainy_image_dataset/label/', temp));  % label: clean image
