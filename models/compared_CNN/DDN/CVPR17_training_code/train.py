...
if __name__ == '__main__':
    ...
    parser.add_argument('--samples_per_gpu', default=240, type=int,  # 8
    ...
    with tf.Session() as sess:
        ...
        for epoch in range(start_epoch, args.epochs+1):
            ...
            for i, (O, B) in enumerate(train_loader):
                ...
                _, l1_loss = sess.run([g_optim, loss], feed_dict={gt: B / 255.0, inputs: O / 255.0, lr:lr_}) #, all_sum
                if i % 1 == 0:
        ...
        log_string('time cost of DDN = {}s'.format(str(end - start)))
        # - time cost of DDN = 16:52:17.831374s 350轮 01-06-16-13 DID