...
class irnn(torch.autograd.Function):
    ...
    @staticmethod
    def forward(ctx, input_feature, weight_up, weight_right, weight_down, weight_left, bias_up, bias_right, bias_down,
                bias_left):
        ...
        ctx.save_for_backward(input_feature, weight_up, weight_right, weight_down, weight_left, output_up, output_right,
                              output_down, output_left)
    ...
    def backward(ctx, grad_output_up, grad_output_right, grad_output_down, grad_output_left):
        ...
        input_feature, weight_up, weight_right, weight_down, weight_left, output_up, output_right, output_down, output_left = ctx.saved_tensors
        # print(weight_left)
