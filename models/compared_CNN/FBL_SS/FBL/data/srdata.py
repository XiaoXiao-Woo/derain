...
class SRData(data.Dataset):
    ...
    def _scan(self):
        # print(os.listdir(os.path.join(self.dir_hr)))
        names_hr = sorted(
            glob.glob(os.path.join(self.dir_hr, '*' + self.ext[0]))
        )
        print(f"scan: {self.dir_hr}, hr: {len(names_hr)}")
    ...
    def _set_filesystem(self, dir_data):
        ...
        print("filesystem:", self.apath, os.listdir(dir_data))
