...
from UDL.derain.compared_CNN.PReNet.util import *
...
if __name__ == '__main__':
    ...
    prepare_data_RainTrainL(cfg.data_dir + "/Rain200L/train/train", 64, 64)
    # fig, axes = plt.subplots(ncols=2, nrows=2)
    # dataset = Dataset(cfg.data_dir + "/Rain100L")
    # loader = DataLoader(dataset, batch_size=2, shuffle=False, num_workers=0)
    # for batch in loader:
    #
    #     samples, gt = batch
    #
    #     axes[0][0].imshow(samples[0].permute(1, 2, 0))
    #     axes[0][1].imshow(gt[0].permute(1, 2, 0))
    #     # plt.show()
    #     # plt.pause(0.5)
    #     axes[1][0].imshow(samples[1].permute(1, 2, 0))
    #     axes[1][1].imshow(gt[1].permute(1, 2, 0))
    #     plt.show()
    #     plt.pause(0.5)
