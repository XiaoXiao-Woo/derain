...
class ipt(nn.Module):
    def __init__(self, args, conv=common.default_conv):
        ...
        self.body = VisionTransformer(img_dim=args.patch_size[0], patch_dim=args.patch_dim, num_channels=n_feats,
...
class VisionTransformer(nn.Module):
    ...
    def forward(self, x, query_idx, con=False):
        ...
        if self.mlp == False:
            x = self.dropout_layer1(self.linear_encoding(x)) + x   # 576,bs,9C @ 9C,D
