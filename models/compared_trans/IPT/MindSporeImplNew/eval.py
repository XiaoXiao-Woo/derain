...
device_id = int(os.getenv('DEVICE_ID', '0'))#GRAPH_MODE
...
def eval_net():
    ...
    net_m = ipt.IPT(args)
    args.pth_path = './experimentmodel_300.ckpt'
    ...
    for batch_idx, imgs in enumerate(train_loader):
        ...
        print("[{}]/[{}] current psnr: ".format(batch_idx, num_imgs), psnr)
