...
# Data specifications
parser.add_argument('--dir_data', type=str, default='../torchImpl/data/',#'../MindSporeImpl/cache/data/'
                    help='dataset directory')
parser.add_argument('--dir_demo', type=str, default='../test',
                    help='demo image directory')
parser.add_argument('--data_train', type=str, default='RainTrainL',
...
parser.add_argument('--scale', type=str, default='2+3+4+1+1+1',
