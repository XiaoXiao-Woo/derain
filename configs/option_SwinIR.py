...
class parser_args(TaskDispatcher, name='SwinIR'):
    def __init__(self, cfg=None):
        ...
        parser.add_argument('-samples_per_gpu', default=4, type=int,  # 8 / 4
        ...
        parser.add_argument('--task_head', type=str, default='real_sr', help='classical_sr, lightweight_sr, real_sr, '
