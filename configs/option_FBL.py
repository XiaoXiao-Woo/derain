...
class parser_args(TaskDispatcher, name='FBL'):
    def __init__(self, cfg=None):
        ...
        script_path = script_path.split('derain')[0]
        ...
        parser.add_argument('--arch', '-a', metavar='ARCH', default='FBL')
        ...
        parser.add_argument('--model', default='RFBLL',
                            help='model name')
